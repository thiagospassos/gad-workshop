...
export default {
  ...
  methods: {
    ...
    remove(cat, id) {
      this.$bvModal
        .msgBoxConfirm(`Please confirm that you want to delete '${cat.name}'.`, {
        ...
        .then(value => {
          if (value) {
            CategoriesService.delete(id)
              ...
              .catch(error => {
                this.raiseErrorNotification(`A server error occurred attempting to delete the category: ${error}`);
              });
          }
        });
    },
