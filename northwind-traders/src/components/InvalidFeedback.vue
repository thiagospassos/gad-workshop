<template>
  <div class="invalid-feedback">
    ...
    <div v-if="containsKey('minValue') && !model.minValue">{{ field }} must be equal or greater than {{ model.$params.minValue.min }}.</div>
    <div v-if="containsKey('minLength') && !model.minLength">{{ field }} must be at least {{ model.$params.minLength.min }} characters.</div>
    <div v-if="containsKey('maxLength') && !model.maxLength">{{ field }} can be at most {{ model.$params.maxLength.max }} characters.</div>
